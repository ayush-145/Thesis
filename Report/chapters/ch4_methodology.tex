...
\begin{figure}[htbp]
    ...
    \caption{Architecture of Swin Transformer V2. The model processes images through four hierarchical stages with progressive spatial downsampling and channel expansion. Within each stage, attention is computed within local windows that alternate between regular and shifted configurations.}
